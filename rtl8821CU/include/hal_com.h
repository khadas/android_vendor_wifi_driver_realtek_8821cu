...
static inline bool rtw_assert_protsel_port(_adapter *padapter, u32 addr, u8 len) {
    return true;
}
...
static inline bool rtw_assert_protsel_atimdtim(_adapter *padapter, u32 addr, u8 len) {
    return true;
}
...
static inline bool rtw_assert_protsel_macsleep(_adapter *padapter, u32 addr, u8 len) {
    return true;
}
